...
import { IProps, IState } from 'types/swipe-action'
...
export default class AtSwipeAction extends AtComponent<IProps, IState> {
    static defaultProps: IProps
    endValue: number
    startX: number | string | any
    startY: number | string | any
