...
export default class AtListItem extends AtComponent<IListItemProps>{
    static defaultProps: IListItemProps
    handleClick = (...args) => {
        if ((typeof this.props.onClick).toLowerCase() === 'function' && !this.props.disabled) {
    ...
    handleSwitchChange = (e) => {
        if ((typeof this.props.onSwitchChange).toLowerCase() === 'function' && !this.props.disabled) {
