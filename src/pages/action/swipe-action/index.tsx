...
import { AtList, AtListItem, AtButton, AtSwipeAction } from 'taro-x'
...
export default class SwipeActionPage extends Component<{}, IState>  {
    config: Config = {
          ...
          <View className='panel'>
            ...
            <View className='panel__content no-padding'>
              <View className='example-item example-item--border'>
                <AtSwipeAction onClick={this.handleClick} options={OPTIONS1}>
